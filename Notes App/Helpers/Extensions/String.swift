...
extension URL {
    ...
    static func isurlInDocumentsDirectory(with filename: String) -> Bool {
        
        let  pathComponent = URL(fileURLWithPath: documentsDirectory).appendingPathComponent(filename)
...
extension String {
    ...
    func height(withConstrainedWidth width: CGFloat, font: UIFont) -> CGFloat {
        ...
        let boundingBox = self.boundingRect(with: constraintRect, options: .truncatesLastVisibleLine, attributes: [NSAttributedString.Key.font: font], context: nil)
...
extension Notification.Name {
    static let videoEditDidFinish = Notification.Name("videoEditDidFinish")
    static let gameInvite = Notification.Name("gameInviteRecieved")
    static let gameTimerFinished = Notification.Name("gameTimerFinished")
}
